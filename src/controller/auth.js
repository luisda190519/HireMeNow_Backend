...
controller.fillProfile = async (req, res) => {
    ...
    try {
        upload.single("image")(req, res, async (err) => {
            ...
            const location = req.body.location.length > 0 ? req.body.location : null;
            ...
            const experience =  req.body.experience ?  req.body.experience.split(",") : [];
            const estudios =  req.body.estudios ?  req.body.estudios.split(",") : [];
